...
var _user$project$Helpers$checkUserInput = F2(
	function (userInput, sequence) {
		var sequenceArr = _elm_lang$core$Array$fromList(sequence);
		var userInputArr = _elm_lang$core$Array$fromList(userInput);
		return A2(
			...
			A3(
						...
						return A2(
							...
							acc,
							{
								...
								_0: A2(
									...
									A2(_elm_lang$core$Array$get, curr, userInputArr),
									A2(_elm_lang$core$Array$get, curr, sequenceArr)),
								_1: {ctor: '[]'}
							});
					}),
				{ctor: '[]'},
				A2(
					_elm_lang$core$List$range,
					0,
					_elm_lang$core$List$length(userInput) - 1)));
	});
var _user$project$Helpers$colorSeq = _elm_lang$core$List$map(
	function (v) {
		var _p0 = v;
		switch (_p0) {
			case 1:
...
var _user$project$Helpers$genSeq = A2(
	_elm_lang$core$Random$list,
	20,
	A2(_elm_lang$core$Random$int, 1, 4));

var _user$project$Ports$playsound = _elm_lang$core$Native_Platform.outgoingPort(
	'playsound',
	function (v) {
		return v;
	});
...
var _user$project$Styles$box = function (color) {
...
var _user$project$Styles$wasClicked = F2(
	function (clicked, color) {
		...
		return _elm_lang$core$Native_Utils.eq(clicked, color) ? _user$project$Styles$box(
			_eskimoblood$elm_color_extra$Color_Convert$colorToHex(
				A2(_eskimoblood$elm_color_extra$Color_Manipulate$lighten, 0.2, c))) : _user$project$Styles$box(color);
	});
var _user$project$Styles$boxContainer = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'display', _1: 'flex'},
		_1: {
...
var _user$project$Main$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {sequence: a, userInput: b, count: c, on: d, strict: e, isRunning: f, clicked: g};
	});
var _user$project$Main$initial = A7(
...
var _user$project$Main$StrictMode = function (a) {
	return {ctor: 'StrictMode', _0: a};
};
var _user$project$Main$ResetColor = {ctor: 'ResetColor'};
var _user$project$Main$AnimateColor = function (a) {
	return {ctor: 'AnimateColor', _0: a};
};
var _user$project$Main$UserClick = function (a) {
	return {ctor: 'UserClick', _0: a};
};
var _user$project$Main$Reset = {ctor: 'Reset'};
var _user$project$Main$Start = {ctor: 'Start'};
var _user$project$Main$view = function (_p0) {
	var _p1 = _p0;
	var _p3 = _p1.isRunning;
	var _p2 = _p1.clicked;
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _user$project$Styles$boxContainer,
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
...
var _user$project$Main$SeqDone = {ctor: 'SeqDone'};
var _user$project$Main$SeqRun = {ctor: 'SeqRun'};
var _user$project$Main$genAnimation = function (count) {
	var seq = A2(
		F2(
			function (x, y) {
				return {ctor: '::', _0: x, _1: y};
			}),
		{ctor: '_Tuple2', _0: 0, _1: _user$project$Main$SeqRun},
		A2(
			_elm_lang$core$Basics_ops['++'],
			A3(
				_elm_lang$core$List$foldl,
				F2(
					function (index, acc) {
						return _elm_lang$core$Native_Utils.eq(index, 0) ? A2(
							_elm_lang$core$Basics_ops['++'],
							acc,
							{
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 1000,
									_1: _user$project$Main$AnimateColor(index)
								},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 300, _1: _user$project$Main$ResetColor},
									_1: {ctor: '[]'}
								}
							}) : A2(
							_elm_lang$core$Basics_ops['++'],
	...
	return _andrewMacmurray$elm_delay$Delay$sequence(
		A2(_andrewMacmurray$elm_delay$Delay$withUnit, _elm_lang$core$Time$millisecond, seq));
};
			...
			case 'NewSequence':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							sequence: _user$project$Helpers$colorSeq(_p4._0)
						}),
					{
						ctor: '::',
						_0: _user$project$Main$genAnimation(model.count),
						_1: {ctor: '[]'}
					});
			case 'Start':
				return model.on ? A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{on: !model.on, count: model.count + 1}),
					{
						ctor: '::',
			...
			case 'Reset':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						...
						{count: 1, on: true, strict: model.strict}),
					{
						ctor: '::',
						_0: A2(_elm_lang$core$Random$generate, _user$project$Main$NewSequence, _user$project$Helpers$genSeq),
						_1: {ctor: '[]'}
			...
			case 'AnimateColor':
				var color = A2(
					...
					A2(
						...
						_p4._0,
						_elm_lang$core$Array$fromList(model.sequence)));
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
					...
					{
						ctor: '::',
						_0: _user$project$Ports$playsound(color),
						_1: {ctor: '[]'}
					});
			case 'UserClick':
				var _p5 = _p4._0;
				var nextUserInput = A2(
					_elm_lang$core$Basics_ops['++'],
					model.userInput,
					{
						ctor: '::',
				...
				var checksPass = A2(_user$project$Helpers$checkUserInput, nextUserInput, model.sequence);
				return model.isRunning ? A2(
						...
						}),
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _user$project$Main$genAnimation(model.count + 1),
								_1: {ctor: '[]'}
							}
						}
					}) : (checksPass ? A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{userInput: nextUserInput, clicked: _p5}),
					{
						ctor: '::',
						_0: _user$project$Ports$playsound(_p5),
						_1: {
